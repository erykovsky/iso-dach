        ...
        <div className="lg:hidden absolute top-full left-0 right-0 bg-white shadow-md">
          <nav className="flex flex-col items-center py-4 space-y-4">
                ...
                <div className="mt-2 w-full flex flex-col items-center space-y-2 py-2 bg-gray-50">
                  {services.map((service, index) => (
                    <Link
                      ...
                      href={service.href}
                      prefetch={true}
                      className="text-gray-700 hover:text-primary transition-colors py-3 px-4 block w-full text-center"
                      onClick={() => {
                        setIsMobileServicesOpen(false);
                        setIsMenuOpen(false);
                      }}
            ...
            <Link
              href="/galeria"
              prefetch={true}
              className="text-primary hover:text-secondary transition duration-300 ease-in-out px-4 py-3 w-full text-center"
              onClick={toggleMenu}
            >
              Galeria
            </Link>
