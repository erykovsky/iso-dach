...
export default function BenefitsPage() {
  return (
    <div className="min-h-screen marketing-page">
      <section className="marketing-hero py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mx-auto max-w-2xl text-white/80">
            Realne oszczędności energii, większy komfort i długofalowa ochrona
            Twojego budynku.
          </p>
        </div>
      </section>
      ...
      <section className="marketing-cta-band mt-12 py-16">
        <div className="container mx-auto px-4">
          <div className="marketing-surface p-8 md:p-12 text-center">
            ...
            <Link
              href="/kontakt"
              className="brand-focus inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-[#32CD32] hover:bg-lime-500/90 transition-colors duration-300 ease-in-out"
            >
