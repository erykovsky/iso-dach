     ...
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {[
       ...
       },
       {
        ...
        description:
         "Nowoczesny materiał o najwyższych parametrach izolacyjnych, aplikowany natryskowo. Tworzy szczelną i jednolitą warstwę izolacji.",
        image: "/placeholder.svg?height=300&width=400",
       },
       {
        title: "Płyty PIR/PUR",
        description:
         "Sztywne płyty o wysokiej izolacyjności termicznej i odporności na wilgoć. Idealne przy ograniczonej przestrzeni na izolację.",
        image: "/placeholder.svg?height=300&width=400",
       },
       {
        title: "Systemy Hybrydowe",
        description:
         "Połączenie różnych materiałów izolacyjnych dla uzyskania optymalnych parametrów termicznych i akustycznych.",
        image: "/placeholder.svg?height=300&width=400",
       },
      ].map((material, index) => (
       <div
