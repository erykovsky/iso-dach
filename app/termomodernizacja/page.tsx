...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "modernizacja energetyczna domu",
    "audyt energetyczny",
    "ocieplenie i termomodernizacja",
    "oszczędność energii w domu",
    "termomodernizacja Szczecin",
  ],
  alternates: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/img/termomodernizacja/hero.jpg",
        width: 1200,
        height: 630,
        alt: "Termomodernizacja budynków ISO-DACH",
      },
    ],
  },
};
  ...
  return (
    <>
      <ServiceSchema
        ...
        url="https://iso-dach.eu/termomodernizacja"
        image="https://iso-dach.eu/img/termomodernizacja/hero.jpg"
      />
...
<h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
        ...
        <GeoAnswerSection
          title="Termomodernizacja to kompleksowy pakiet prac, który obniża zapotrzebowanie budynku na energię."
          answer="Najlepszy efekt daje połączenie kilku działań: poprawy izolacji przegród, modernizacji źródła ciepła oraz optymalizacji wentylacji. Dzięki temu budynek zużywa mniej energii, a komfort cieplny rośnie."
          bullets={[
            "Niższe koszty ogrzewania i chłodzenia budynku.",
            "Lepszy komfort cieplny i stabilniejsza temperatura w pomieszczeniach.",
            "Wzrost wartości nieruchomości po modernizacji energetycznej.",
          ]}
          qa={[
            {
              question: "Czy trzeba robić wszystko jednocześnie?",
              answer:
                "Nie, ale warto oprzeć etapy na spójnym planie, żeby kolejne prace nie dublowały kosztów i dawały maksymalny efekt.",
            },
            {
              question: "Od czego najlepiej zacząć termomodernizację?",
              answer:
                "Najczęściej od audytu i diagnozy największych strat ciepła, a potem od przegród o największym wpływie na bilans energetyczny.",
            },
            {
              question: "Czy termomodernizacja ma sens w starszym domu?",
              answer:
                "Tak. W starszych budynkach potencjał poprawy efektywności jest zwykle największy, co skraca czas zwrotu inwestycji.",
            },
          ]}
          localNote="Termomodernizacje realizujemy głównie w województwie zachodniopomorskim, z możliwością obsługi inwestycji również w innych częściach Polski."
          relatedLinks={[
            { href: "/izolacja-poddaszy", label: "Izolacja poddaszy" },
            { href: "/ocieplanie-stropodachu", label: "Ocieplanie stropodachu" },
            { href: "/izolacja-stropow-piwnic", label: "Izolacja stropów piwnic" },
          ]}
        />
