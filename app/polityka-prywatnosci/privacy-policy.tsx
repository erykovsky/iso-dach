...
<h1 className="text-4xl font-bold text-white md:text-5xl">
                        ...
                        <p className="mx-auto mt-4 max-w-2xl text-white/85">
                            Informacje o zasadach przetwarzania i ochrony danych
                            osobowych użytkowników strony ISO-DACH.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="section-shell py-10 md:py-14">
                <div className="section-inner container mx-auto px-4">
                    <article className="mx-auto max-w-5xl marketing-surface p-5 sm:p-6 md:p-8 lg:p-10">
                        <div className="space-y-9 text-sm leading-relaxed text-foreground/90 md:text-base">
                            <section>
                            ...
                            <section>
                                ...
                                <p>
                                    ...
                                    zbierane są dane dotyczące wizyty Użytkownika, np. adres IP, nazwa domeny,
                            ...
                            <section>
                                ...
                                <p>
                                    ...
                                    za pośrednictwem adresu e-mail: info@iso-dach.eu lub pisemnie na adres
                            ...
                            <section>
                                ...
                                <p className="mb-4">
                                    Strona internetowa ISO-DACH wykorzystuje pliki cookies (tzw. &quot;ciasteczka&quot;),
                                    które stanowią dane informatyczne, w szczególności pliki tekstowe,
                                    przechowywane w urządzeniu końcowym Użytkownika.
                                </p>
                            ...
                            <section>
                                <h2 className="mb-4 text-2xl font-semibold text-primary">11. Kontakt</h2>
                                <p className="mb-4">
                            ...
                            <p className="border-t border-primary/10 pt-6 text-sm text-muted-foreground">
